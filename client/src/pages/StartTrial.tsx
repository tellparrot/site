...
export function StartTrial() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Your trial has been started. Check your email for next steps.",
      })
      navigate("/")
    } catch (error) {
      toast({
      ...
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-6 py-24">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6">Start Your Free Trial</h1>
            <p className="text-xl mb-8 text-blue-100">
              Get started with Parrot's complete role management solution
            </p>
          </div>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 rounded-xl shadow-sm">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="company" placeholder="Enter your company name" className="pl-10" required />
                </div>
              </div>
              ...
              <p className="text-center text-sm text-gray-500">
                By starting a free trial, you agree to our terms of service and privacy policy.
              </p>
            </form>
          </div>
        </div>
